...
std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"ForceHarnessRelayOn", PERSISTENT},
    ...
    {"HrrUpdateInProgress", PERSISTENT},
    {"HrrUpdatePending", PERSISTENT},
    {"HrrUpdateDeadline", PERSISTENT},
    {"HrrUpdateStatus", CLEAR_ON_MANAGER_START | CLEAR_ON_ONROAD_TRANSITION},
    {"HrrUpdateDownloadRequest", CLEAR_ON_MANAGER_START},
    {"HrrUpdateStartupHold", CLEAR_ON_MANAGER_START | CLEAR_ON_ONROAD_TRANSITION},
    {"HrrAutoInstall", PERSISTENT},
    {"HrrAllowPrerelease", PERSISTENT},
    {"HrrUpdaterReady", CLEAR_ON_MANAGER_START | CLEAR_ON_ONROAD_TRANSITION},
    {"HrrUpdaterRequested", CLEAR_ON_MANAGER_START | CLEAR_ON_ONROAD_TRANSITION},
    {"IMEI", PERSISTENT},
    ...
    {"Offroad_HrrFirmwareUpdate", CLEAR_ON_MANAGER_START | CLEAR_ON_ONROAD_TRANSITION},
