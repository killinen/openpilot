...
std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"CanBus0Speed", PERSISTENT},
    {"CanBus1Speed", PERSISTENT},
    {"CanBus2Speed", PERSISTENT},
    ...
    {"Offroad_TrqiFirmwareUpdate", CLEAR_ON_MANAGER_START | CLEAR_ON_ONROAD_TRANSITION},
    ...
    {"TrqiAllowPrerelease", PERSISTENT},
    {"TrqiAutoInstall", PERSISTENT},
    {"TrqiGithubToken", PERSISTENT | DONT_LOG},
    {"TrqiUpdateDeadline", PERSISTENT},
    {"TrqiUpdateDownloadRequest", CLEAR_ON_MANAGER_START},
    {"TrqiUpdateInProgress", PERSISTENT},
    {"TrqiUpdatePending", PERSISTENT},
    {"TrqiUpdateProgress", CLEAR_ON_MANAGER_START},
    {"TrqiUpdateRecoverySafe", PERSISTENT},
    {"TrqiUpdaterReady", CLEAR_ON_MANAGER_START | CLEAR_ON_ONROAD_TRANSITION},
    {"TrqiUpdaterRequested", CLEAR_ON_MANAGER_START | CLEAR_ON_ONROAD_TRANSITION},
    {"TrqiUpdateStartupHold", CLEAR_ON_MANAGER_START | CLEAR_ON_ONROAD_TRANSITION},
    {"TrqiUpdateStatus", CLEAR_ON_MANAGER_START},
    {"TRQISteeringToggle", PERSISTENT},
    ...
    {"CurveSpeedLateralAcceleration", PERSISTENT},
