...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"AvailableModelVersions", {PERSISTENT, STRING, "", "", 1}},
    ...
    {"CarMake", {PERSISTENT, STRING, "", "", 0}},
    {"CarModel", {PERSISTENT, STRING, "", "", 0}},
    ...
    {"CustomColors", {PERSISTENT, STRING, "frog", "stock", 0}},
    {"CustomCruise", {PERSISTENT, FLOAT, "1.0", "1.0", 2}},
    {"CustomCruiseLong", {PERSISTENT, FLOAT, "5.0", "5.0", 2}},
    {"CustomDistanceIcons", {PERSISTENT, STRING, "stock", "stock", 0}},
    {"CustomIcons", {PERSISTENT, STRING, "frog-animated", "stock", 0}},
    {"CustomPersonalities", {PERSISTENT, BOOL, "0", "0", 2}},
    {"CustomSignals", {PERSISTENT, STRING, "frog", "stock", 0}},
    {"CustomSounds", {PERSISTENT, STRING, "frog", "stock", 0}},
    ...
    {"ExperimentalGMTune", {PERSISTENT, BOOL, "0", "0", 2}},
    {"Fahrenheit", {PERSISTENT, BOOL, "0", "0", 3}},
    {"FavoriteDestinations", {PERSISTENT, STRING, "", "", 0}},
    ...
    {"ForceMPHDashboard", {PERSISTENT, BOOL, "0", "0", 3}},
    ...
    {"GasRegenCmd", {PERSISTENT, BOOL, "1", "0", 2}},
    ...
    {"MinimumLaneChangeSpeed", {PERSISTENT, FLOAT, "45.0", "45.0", 2}},
    {"Model", {PERSISTENT, STRING, "", "", 1}},
    ...
    {"NextMapSpeedLimit", {CLEAR_ON_MANAGER_START, FLOAT, "0.0", "0.0"}},
    ...
    {"PersonalizeOpenpilot", {PERSISTENT, BOOL, "1", "0", 0}},
    ...
    {"RelaxedPersonalityProfile", {PERSISTENT, BOOL, "1", "0", 2}},
    ...
    {"StandardPersonalityProfile", {PERSISTENT, BOOL, "1", "0", 2}},
    ...
    {"TestAlert", {CLEAR_ON_MANAGER_START, BOOL, "0", "0"}},
    ...
    {"TrafficPersonalityProfile", {PERSISTENT, BOOL, "1", "0", 2}},
