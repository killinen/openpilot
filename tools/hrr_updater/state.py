...
class StateStore:
  ...
  def set_active(self, manifest: Path, image: Path, version: str, image_identity: str) -> None:
    value = self.load()
  ...
  def set_pending(self, tag: str, version: str, slots: dict[str, dict[str, str]]) -> None:
    value = self.load()
