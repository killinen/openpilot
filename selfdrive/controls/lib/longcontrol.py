...
from selfdrive.controls.lib.pid import PIControllerLong
...
def long_control_state_trans(active, long_control_state, v_ego, v_target, v_pid,
  ...
  stopping_condition = (v_ego < 2.0 and cruise_standstill) or \    <- Original statements
  #stopping_condition = (v_ego < 2.0) or \
...
class LongControl():
  def __init__(self, CP, compute_gb):
    ...
    self.pid = PIControllerLong((CP.longitudinalTuning.kpBP, CP.longitudinalTuning.kpV),
