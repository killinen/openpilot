...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp_cam):
    ...
    ret.brakeHoldActive = cp.vl["DME_2"]["BRAKE_LIGHT_SIGNAL"] == 1     # This might not work!!! Check this!!!
  ...
  def get_can_parser(CP):
    ...
    signals = [
      ...
      #("DOOR_OPEN_FL", "IKE_2", 0),     #Imported from BMW
      #("DOOR_OPEN_FR", "IKE_2", 0),     #Imported from BMW
      #("DOOR_OPEN_RL", "IKE_2", 0),     #Imported from BMW
      #("DOOR_OPEN_RR", "IKE_2", 0),     #Imported from BMW
      #("SEATBELT_DRIVER_UNLATCHED", "IKE_2", 0),      #Imported from BMW
    ...
    return CANParser(DBC[CP.carFingerprint]["pt"], signals, checks, 0, enforce_checks=True)
