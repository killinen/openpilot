...
from selfdrive.car.toyota.values import Ecu, CAR, STATIC_DSU_MSGS, NO_STOP_TIMER_CAR, TSS2_CAR, \
...
class CarController():
  ...
  def update(self, enabled, CS, frame, actuators, pcm_cancel_cmd, hud_alert,
    ...
    if not enabled or CS.steer_state in [9, 25] or CS.out.epsDisabled==1:
      apply_steer = 0
      apply_steer_req = 0
    else:
      apply_steer_req = 1
