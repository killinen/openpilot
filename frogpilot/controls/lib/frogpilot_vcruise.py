...
class FrogPilotVCruise:
  def __init__(self, FrogPilotPlanner, params):
    ...
    self.slc = SpeedLimitController(params)
  ...
  def update(self, gps_position, long_control_active, now, time_validated, v_cruise, v_ego, params, params_memory, sm, frogpilot_toggles):
    ...
    if self.frogpilot_planner.lead_one.vLead < v_ego > CRUISING_SPEED and long_control_active and self.frogpilot_planner.tracking_lead and frogpilot_toggles.human_following:
    ...
    if frogpilot_toggles.speed_limit_controller:
      self.slc.update_limits(sm["frogpilotCarState"].dashboardSpeedLimit, gps_position, now, time_validated, v_cruise, v_ego, params, params_memory, sm)
